...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-transparent" style="background: linear-gradient(#eba4b6,#ff3669,#ff0041);">
  <!--used for brand image-->
    <div class="navbar-header" style="width:45%">
        <a href="index.php" class="navbar-brand text-white"><img src="image\fl.png"  alt=""  style="font-family: 'Modak', cursive; width:30%;height:35px" > </a>
    </div>
...
<?php endif; ?>
                ...
                <h4 class="modal-title">Directly contect on phone </h4><hr>
                </div>
                <div class="modal-body">
                  Having trouble in accesing direct caal us for place your orders.
                </div>
                <div class="modal-footer">
