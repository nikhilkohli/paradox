          ...
          <div class="card shadow-sm mt-4 text-capitalize" style="font-family: 'Josefin Sans', sans-serif;">
              <div class="row mt-4 ml-3">
                ...
                <div class="col-lg-4" style="border-left: solid 1px #ccc">
                  ...
                  <h6>Get Free Home delivery on shopping of Rs.1999 or above.</h6>
                </div>
                ...
                <div class="col-lg-4" style="border-left: solid 1px #ccc">
                  ...
                  <p style="color:#556"><i class="fab fa-get-pocket text-info" ></i>   Get in touch with us: <br> <a href="#" style="color:#556; margin-left:5%">ideasdo.edu@gmil.com</a> </p>
